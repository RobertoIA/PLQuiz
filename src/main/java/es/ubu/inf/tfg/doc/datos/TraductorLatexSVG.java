...
public class TraductorLatexSVG extends Traductor {
	...
	public String documento(List<Plantilla> problemas) {
		...
		Plantilla plantilla = new Plantilla("plantillaSVG.tex"); //$NON-NLS-1$
	...
	public Plantilla traduceASUConstruccion(AhoSethiUllman problema) {
		...
		plantilla.set("includetool", "\\myincludesvgsol"); //$NON-NLS-1$
	...
	public Plantilla traduceASUEtiquetado(AhoSethiUllman problema) {
		...
		plantilla.set("includetool", "\\myincludesvg"); //$NON-NLS-1$
