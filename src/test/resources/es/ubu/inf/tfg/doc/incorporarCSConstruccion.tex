...
Dibuja el autómata generado por la expresión regular $ (a|b^*)c^*a $ siguiendo el método de Thompson.
    \myincludegraphicssol{}

\paragraph{3.-}\label{p3}
Dibuja el autómata generado por la expresión regular $ (a|b)^*a(a|b)(a|b) $ siguiendo el método de Thompson.
    \myincludegraphicssol{}
