...
Aplicar el algoritmo de Aho-Sethi-Ullman a la expresión regular: \textbf{$ ((a|b^*)a^*c)^* $} \\
\\
...
Aplicar el algoritmo de Aho-Sethi-Ullman a la expresión regular: \textbf{$ (a|b^*)c^*a $} \\
\\
...
Aplicar el algoritmo de Aho-Sethi-Ullman a la expresión regular: \textbf{$ (a|b)^*a(a|b)(a|b) $} \\
\\
Expresión aumentada: \h{$ (a|b)^*\cdot a\cdot (a|b)\cdot (a|b)\cdot \$  $} \\
