...
Dibuja el árbol sintáctico correspondiente a la siguiente expresión regular $ (a|b^*)c^*a $.
	\myincludegraphicssol{}


\paragraph{3.-}\label{p3}
Dibuja el árbol sintáctico correspondiente a la siguiente expresión regular $ (a|b)^*a(a|b)(a|b) $.
	\myincludegraphicssol{}
