...
\imagen{thompson-ejemplo-arbol}{Árbol de la expresión regular (a\textbar b)*}
...
\imagen{thompson-ejemplo-union}{Autómata para la expresión a\textbar b}
...
\imagen{thompson-ejemplo-cierre}{Autómata para la expresión (a\textbar b)*}
